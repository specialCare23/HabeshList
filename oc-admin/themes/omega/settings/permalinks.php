  ...
  $(document).ready(function(){
    ...
    $("form[name=permalinks_form]").validate({
      ...
      messages: {
        ...
        rewrite_item_deactivate: {
          required: '<?php echo osc_esc_js( __("Deactivate listing url: this field is required")); ?>.',
          minlength: '<?php echo osc_esc_js( __("Deactivate listing url: this field is required")); ?>.'
        },
        rewrite_item_renew: {
  ...
  <div id="mail-settings">
    ...
    <form name="settings_form" class="separate-top" action="<?php echo osc_admin_base_url(true); ?>" method="post">
      ...
      <div id="custom_rules" <?php if( !osc_rewrite_enabled() ) { echo 'class="hide"'; } ?>>
        <div id="show_hide" ><a href="#" class="btn" onclick="javascript:showhide();"><?php _e('Show rules'); ?></a></div>
        <div id="inner_rules" class="hide">
          <div class="form-row">
            ...
            <div class="form-controls">
              ...
              <div class="help-box">
                <?php echo sprintf(__('Accepted keywords: %s'), '{ITEM_ID},{CATEGORIES},{ITEM_TITLE},{ITEM_COUNTRY},{ITEM_COUNTRY_CODE},{ITEM_REGION},{ITEM_CITY},{ITEM_CITY_AREA},{ITEM_ZIP},{ITEM_CONTACT_NAME},{ITEM_CONTACT_EMAIL},{ITEM_CURRENCY_CODE},{ITEM_PUB_DATE}'); ?>
              </div>
            </div>
          </div>
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="form-controls">
              <input type="text" class="input-large" name="rewrite_item_deactivate" value="<?php echo osc_esc_html(osc_get_preference('rewrite_item_deactivate')); ?>" />
            </div>
          </div>
          <div class="form-row">
