        ...
        <fieldset>
          ...
          <div class="form-row">
            ...
            <div class="form-controls">
              ...
              <span class="help-box"><strong><?php _e('BETA!'); ?></strong> <?php _e('This feature is in beta stage and require proper testing before using on production website. Only works with Friendly URLs enabled!'); ?></span>
            </div>
          </div>
