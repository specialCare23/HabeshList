...
function anr_is_demo() {
  ...
  if(anr_is_demo()) {
    osc_add_flash_error_message(__('You cannot access this plugin on demo', 'rad_search'), 'admin');
    header('Location:' . osc_base_url() . 'oc-admin/index.php?page=plugins&m=1');
    exit;
  }
