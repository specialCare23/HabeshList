...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div>
        <img border="0" src="<?php echo osc_current_web_theme_url('images/advertize_here.jpg'); ?>" alt="advertize here">
        </div>
        <div class="content home">
            ...
            <div style="page-break-before: always;">
                    <br>
                    <img border="0" width="200" height="200" src="<?php echo osc_current_web_theme_url('images/Kids_Turor.jpg'); ?>">
                    <br><br><br>
                    <img border="0" width="200" height="200" src="<?php echo osc_current_web_theme_url('images/advertize_here2.jpg'); ?>">
                    <br><br><br>
                    <img border="0" width="200" height="200" src="<?php echo osc_current_web_theme_url('images/SCR.jpg'); ?>">
                    <br><br><br>
                </div>
