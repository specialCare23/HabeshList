      ...
      if($subdomain != '' && $subdomain !== 'www') {
        if($subdomain_type === 'category') {
          ...
          if(isset($category['pk_i_id'])) {
            View::newInstance()->_exportVariableToView('subdomain_id', $category['pk_i_id']);
          ...
          if(isset($country['pk_c_code'])) {
            View::newInstance()->_exportVariableToView('subdomain_id', $country['pk_c_code']);
          ...
          if(isset($region['pk_i_id'])) {
            View::newInstance()->_exportVariableToView('subdomain_id', $region['pk_i_id']);
          ...
          if(isset($city['pk_i_id'])) {
            View::newInstance()->_exportVariableToView('subdomain_id', $city['pk_i_id']);
          ...
          if(isset($user['pk_i_id'])) {
            View::newInstance()->_exportVariableToView('subdomain_id', $user['pk_i_id']);
